...
public class ListAdapter extends ArrayAdapter<ListItems> {
	...
	public ListAdapter(Context context, ArrayList<ListItems> arrayList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		linearLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(position==0){
					context.startActivity(new Intent(context, FragmentList.class));
				}
				else if(position==1){
					context.startActivity(new Intent(context, CodeView.class));
				}
				else if(position==2){
